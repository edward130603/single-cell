...
##load data
data1 = readRDS("data/GSE64016.rds")
...
#sca = subset(sca, sca$source_name_ch1 %in% c("single H1-Fucci cell sorted from G1 phase of the cell cycle only", "single H1-Fucci cell sorted from S phase of the cell cycle only"))
